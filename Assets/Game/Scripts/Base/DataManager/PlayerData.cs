...
public class PlayerData {
    ...
    public List<ItemStack> eventory = new List<ItemStack>(){new ItemStack(ItemID.COIN,300),new ItemStack(ItemID.LUCKYWEEL,3),new ItemStack(ItemID.ITEMBOW,3),new ItemStack(ItemID.ITEMSWORD,3), new ItemStack(ItemID.LIFE,3)};
